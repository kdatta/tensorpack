...
__all__ = ['MaxPooling', 'FixedUnPooling', 'FixedUnPooling_fix', 'AvgPooling', 'GlobalAvgPooling']
...
@layer_register(log_shape=True)
def FixedUnPooling_fix(x, shape, unpool_mat=None, data_format='channels_last'):
    """
    Unpool the input with a fixed matrix to perform kronecker product with.
